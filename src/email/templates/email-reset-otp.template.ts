export function getEmailResetOtpTemplate(code: string, expiryTime: string): string {
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; overflow: hidden;"> 
        ...
        <div style="padding: 30px 35px;">       
          <p style="padding-top: 5px;">
            To reset your Nurtura email address, please use the One Time Password (OTP) below.
            Enter this code in the email reset page to proceed.
          </p>
          <center>
        ...
        <div style="text-align: center; padding: 25px 20px; background-color: #f9f9f9; border-top: 1px solid #eaeaea;">
          ...
          <p style="font-size: 10px; color: #999999; margin-top: 15px;">
            You are receiving this email because an email reset was requested for your Nurtura account.

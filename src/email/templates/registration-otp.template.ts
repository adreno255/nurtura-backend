export function getRegistrationOtpTemplate(code: string, expiryTime: string): string {
    ...
    <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; line-height: 1.5; background-color: white; padding: 20px;">
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px; overflow: hidden;"> 
        <div style="background-color: #19350C; color: white; padding: 45px 35px;">
        ...
        <div style="padding: 30px 35px;">       
          <p>To authenticate your email address, here is your One Time Password (OTP). Please enter this code to verify your email address for Nurtura.</p>
          <center>
          ...
          <p style="margin-bottom: 40px;">Best Regards,<br><b style="color: #19350C;">LoamTech Team</b></p>
        </div>
        <div style="text-align: center; padding: 25px 20px; background-color: #f9f9f9; border-top: 1px solid #eaeaea;">
          ...
          <p style="font-size: 10px; color: #999999; margin-top: 15px;">You are receiving this mail because you registered to join the Nurtura platform as a user.</p>
        </div>
      </div>
    </div>
  `;

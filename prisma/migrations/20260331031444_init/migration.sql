...
-- CreateEnum
CREATE TYPE "activity_event_type" AS ENUM ('RACK_ADDED', 'RACK_RENAMED', 'RACK_REMOVED', 'PLANT_ADDED', 'PLANT_REMOVED', 'PLANT_CHANGED', 'PLANT_HARVESTED', 'LIGHT_ON', 'LIGHT_OFF', 'WATERING_START', 'WATERING_STOP', 'AUTOMATION_TRIGGERED', 'DEVICE_ONLINE', 'DEVICE_OFFLINE');

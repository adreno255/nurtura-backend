...
-- CreateEnum
CREATE TYPE "activity_event_type" AS ENUM ('RACK_ADDED', 'RACK_RENAMED', 'RACK_REMOVED', 'PLANT_ADDED', 'PLANT_REMOVED', 'PLANT_CHANGED', 'LEAVES_HARVESTED', 'PLANT_HARVESTED', 'SEEDS_HARVESTED', 'LIGHT_ON', 'LIGHT_OFF', 'WATERING_START', 'WATERING_STOP', 'AUTOMATION_TRIGGERED', 'DEVICE_ONLINE', 'DEVICE_OFFLINE');

-- CreateEnum
CREATE TYPE "notification_type" AS ENUM ('INFO', 'ERROR', 'AUTOMATION');
...
-- CreateEnum
CREATE TYPE "WateringState" AS ENUM ('RUNNING', 'STOPPED');

-- CreateEnum
CREATE TYPE "LightState" AS ENUM ('ON', 'OFF');
...
CREATE TABLE "users" (
    ...
    "completed_pages" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
CREATE TABLE "plants" (
    ...
    "max_light_level" DOUBLE PRECISION,
...
CREATE TABLE "racks" (
    ...
    "watering_state" "WateringState" NOT NULL DEFAULT 'STOPPED',
    "light_state" "LightState" NOT NULL DEFAULT 'OFF',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "automation_rules_plant_id_idx" ON "automation_rules"("plant_id");
...
-- AddForeignKey
ALTER TABLE "automation_rules" ADD CONSTRAINT "automation_rules_plant_id_fkey" FOREIGN KEY ("plant_id") REFERENCES "plants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

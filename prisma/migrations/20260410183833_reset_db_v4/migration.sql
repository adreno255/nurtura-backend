/*
  ...
  - You are about to drop the `rack_planting_history` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "automation_rules" DROP CONSTRAINT "automation_rules_plant_id_fkey";
...
-- DropForeignKey
ALTER TABLE "rack_planting_history" DROP CONSTRAINT "rack_planting_history_plant_id_fkey";

-- DropForeignKey
ALTER TABLE "rack_planting_history" DROP CONSTRAINT "rack_planting_history_rack_id_fkey";

-- DropForeignKey
ALTER TABLE "racks" DROP CONSTRAINT "racks_current_plant_id_fkey";
...
-- DropTable
DROP TABLE "rack_planting_history";
...
-- DropEnum
DROP TYPE "LightState";

-- DropEnum
DROP TYPE "WateringState";

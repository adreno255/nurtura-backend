...
-- CreateEnum
CREATE TYPE "activity_event_type" AS ENUM ('RACK_ADDED', 'RACK_RENAMED', 'RACK_REMOVED', 'PLANT_ADDED', 'PLANT_REMOVED', 'PLANT_CHANGED', 'LEAVES_HARVESTED', 'PLANT_HARVESTED', 'SEEDS_HARVESTED', 'LIGHT_ON', 'LIGHT_OFF', 'WATERING_ON', 'WATERING_OFF', 'AUTOMATION_TRIGGERED', 'DEVICE_ONLINE', 'DEVICE_OFFLINE');

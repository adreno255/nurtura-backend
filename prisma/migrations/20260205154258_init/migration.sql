...
-- CreateEnum
CREATE TYPE "activity_event_type" AS ENUM ('RACK_ADDED', 'RACK_REMOVED', 'PLANT_ADDED', 'PLANT_REMOVED', 'PLANT_HARVESTED', 'LIGHT_ON', 'LIGHT_OFF', 'WATERING_ON', 'WATERING_OFF', 'SENSORS_ON', 'SENSORS_OFF', 'SYSTEM_START', 'SYSTEM_STOP', 'SENSOR_READING', 'AUTOMATION_TRIGGERED', 'DEVICE_ONLINE', 'DEVICE_OFFLINE');
